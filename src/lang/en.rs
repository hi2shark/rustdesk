...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("must_setup_server_tip", "Please configure ID/Relay Server before connecting"),
        ...
        ("websocket_tip", "When using WebSocket-only mode, only relay connections are supported."),
        ...
        ("server-oss-not-support-tip", "NOTE: Requires a server with native WebSocket / TCP-only registration enabled (ENABLE_NATIVE_WEBSOCKET or ENABLE_TCP_ONLY_REGISTRATION). Classic OSS without these flags will reject TCP/WS registration."),
        ("transport-mode", "Transport mode"),
        ("transport-mode-tip", "Auto: classic UDP/TCP/Relay.\nTCP-only: no UDP, TCP signaling + TCP relay.\nWebSocket-only: no UDP, WebSocket signaling + WebSocket relay."),
        ("transport-mode-auto", "Auto"),
        ("transport-mode-tcp-only", "TCP only"),
        ("transport-mode-websocket-only", "WebSocket only"),
