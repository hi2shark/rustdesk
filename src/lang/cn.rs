...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("must_setup_server_tip", "请先配置 ID/中转服务器后再连接"),
        ...
        ("All monitors", "所有显示器"),
        ("#{} monitor", "{}号显示器"),
        ("HQ Video Profile", "HQ 画质配置"),
        ("Enable HQ video engine", "启用 HQ 画质引擎"),
        ("Office clear (VP9 I444)", "办公清晰（VP9 I444）"),
        ("Motion smooth (H.265 HW)", "动态流畅（H.265 硬件编码）"),
        ("Office clear", "办公清晰"),
        ("Motion smooth", "动态流畅"),
        ("TCP stable", "TCP 稳定"),
        ("Rate control", "码率控制"),
        ...
        ("Max FPS", "最高帧率"),
        ("Max queue", "最大队列"),
        ("Chroma preference", "色度偏好"),
        ("Allow codec fallback", "允许编码器回退"),
        ("Copy report", "复制报告"),
        ("Target Bitrate", "目标码率"),
        ("Chroma", "色度"),
        ("Queue", "队列"),
