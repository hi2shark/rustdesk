...
class _ConnectionPageState extends State<ConnectionPage> {
  ...
  final RxBool _isUsingPublicServer = true.obs;
  ...
  void initState() {
    ...
    _serverGuideTimer = periodic_immediate(const Duration(seconds: 2), () async {
      _isUsingPublicServer.value = await bind.mainIsUsingPublicServer();
    });
  }
  ...
  /// Guide to configure self-hosted ID/Relay Server when not set.
  Widget _buildServerGuideUI() {
    if (!_isUsingPublicServer.value) {
    ...
    return InkWell(
        ...
        child: Container(
            ...
            child: Text(translate('must_setup_server_tip'),
